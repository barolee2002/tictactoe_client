...
public class FriendRequestFrm extends javax.swing.JFrame {
    ...
    private void acceptButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_acceptButtonActionPerformed
        try {
            timer.stop();
    ...
    private void declineButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_declineButtonActionPerformed
        timer.stop();
        this.dispose();
